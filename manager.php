...
<?php
						...
						echo "<td><button type='submit' class='btn btn-outline-success btn-block' formaction='#' >Обзор</button></td>";
						echo "<td><button type='submit' class='btn btn-outline-danger btn-block' formaction='#'>Закончить</button></td>";
...
while ($result=mysqli_fetch_array($sql)){
    ...
    echo "<td><button type='submit' class='btn btn-outline-success btn-block' formaction='ok.php' >Подтвердить</button></td>";
    echo "<td><button type='submit' class='btn btn-outline-danger btn-block' formaction='del.php'>Отклонить</button></td>";
